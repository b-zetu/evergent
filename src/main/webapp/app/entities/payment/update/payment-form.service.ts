...
type PaymentFormGroupContent = {
  ...
  shareholder: FormControl<IPayment['shareholder']>;
  dividendCalculation: FormControl<IPayment['dividendCalculation']>;
  paymentOption: FormControl<IPayment['paymentOption']>;
};
...
export class PaymentFormService {
  createPaymentFormGroup(payment: PaymentFormGroupInput = { id: null }): PaymentFormGroup {
    ...
    return new FormGroup<PaymentFormGroupContent>({
      ...
      shareholder: new FormControl(paymentRawValue.shareholder),
      dividendCalculation: new FormControl(paymentRawValue.dividendCalculation),
      paymentOption: new FormControl(paymentRawValue.paymentOption),
    });
  }
