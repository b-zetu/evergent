...
import com.evergent.domain.Group;
import com.evergent.repository.GroupRepository;
...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().name(DEFAULT_NAME).code(DEFAULT_CODE);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().name(UPDATED_NAME).code(UPDATED_CODE);
        return group;
    }
    ...
    void putExistingGroup() throws Exception {
        ...
        updatedGroup.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.name(UPDATED_NAME).code(UPDATED_CODE);
